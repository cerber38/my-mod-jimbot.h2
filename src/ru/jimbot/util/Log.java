...
/**
* <p>Logger wrapper class.<br> Provides static methods to the Log4J logging
* methods. This is a convenience class only and can not be instantiated.
*
* @author Takis Diakoumis, Prolubnikov Dmitry
* @version $Revision: 1.1 $ @date $Date: 2006/12/15 17:34:39 $
*/
...
*/
private static Logger system, err, http, talk, flood;
/**
